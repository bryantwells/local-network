...
export class IcecastService {
     ...
     */
    async createSource(userId, mountId, metadata) {

        // Send empty buffer to icecast
        await this.putSourceData(userId, mountId, Buffer.alloc(10), metadata);
    }
     ...
     * @param {Object} metadata
     */
    async putSourceData(userId, mountId, data, metadata) {
        ...
        client.putSourceData(userId, mountId, data);
     ...
     * @param {string} mountId 
     */
    async killSource(userId, mountId) {
