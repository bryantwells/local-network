...
<template>
	<div class="AudioForm">
		...
		<section class="AudioForm-submit">
			<AudioRecorder
				:user-id="userId"
				:metadata="{
					title,
...
.AudioForm-input--select {
	background: white;
	background-image: url("data:image/svg+xml;utf8,<svg fill='rgb(255,0,0)' height='10' width='10' xmlns='http://www.w3.org/2000/svg'><polygon points='0,1 5,9 10,1'/></svg>");
